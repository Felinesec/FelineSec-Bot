...
from commands import start, server, help, definisci, rules, setrules, kill, ping
...
def main():
    ...
    capture_message("Il bot e' stato avviato con successo")
